...
# Mystical Seed Infusion Chamber - Author: Genin
recipes.addShaped(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:mystical_seed_infusion_chamber"}), [[<mysticalagriculture:growth_accelerator>, <lightningcraft:material:9>, <mysticalagriculture:growth_accelerator>], [<lightningcraft:material:9>, <agricraft:crop_sticks>, <lightningcraft:material:9>], [<mysticalagriculture:growth_accelerator>, <lightningcraft:material:9>, <mysticalagriculture:growth_accelerator>]]);
